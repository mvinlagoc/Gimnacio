package model.seguridades.managers;
...
import model.core.entities.SegAsignacion;
import model.core.entities.SegModulo;
import model.core.entities.SegPerfil;
import model.core.entities.SegUsuario;
import model.core.managers.ManagerDAO;
import model.core.utils.ModelUtil;
import model.seguridades.dtos.LoginDTO;
...
public class ManagerSeguridades {
    ...
    public String inicializarDemo() throws Exception {
    	...
    	if(admin==null) {
			...
			admin.setCorreo("admin@gymcenterdemo.com");
